    ...
    return Scaffold(
      ...
      body: SafeArea(
        ...
        child: Column(
          ...
          children: [
            // Glass header — two states via _showRooms ('Сообщения' / 'Комнаты').
            SeeUGlassBar(
              titleText: _showRooms ? 'Комнаты' : 'Сообщения',
    ...
    return Column(
      children: [
        SeeUGlassSearchBar(
          ...
          onClear: _roomSearchQuery.isNotEmpty
              ? () {
                  _roomSearchDebounce?.cancel();
          ...
          children: [
            ...
            Row(
              ...
              children: [
                ...
                const SizedBox(width: 10),
                // Ghost create — единственная главная CTA живёт в glass-баре.
                SeeUButton(
                  label: 'Создать',
                ...
                children: [
                  ...
                  Text(
                    ...
                    style: SeeUTypography.displayS.copyWith(
                        fontWeight: FontWeight.w500, height: 1.1, color: c.ink),
                  ),
                ],
              ),
            ),
